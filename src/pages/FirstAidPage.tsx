...
const defaultGuides: Guide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "If they cannot breathe, call emergency services (112).",
  ...
  },
  {
    ...
    steps: [
      ...
      "For severe burns (large area, face, hands, feet, genitals), call 112 immediately.",
  ...
  },
  {
    ...
    severity: "high",
    steps: [
      "Call emergency services (112) if the fracture is severe or the person cannot move.",
  ...
  },
  {
    ...
    severity: "critical",
    steps: [
      "Stay calm and immediately call emergency services (112).",
  ...
  },
  {
    ...
    steps: [
      ...
      "If ANY of these signs: Call 112 IMMEDIATELY. Note the time symptoms started.",
      ...
      <div className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="flex items-center gap-3 bg-destructive/10 border border-destructive/20 rounded-xl p-4 mb-8">
          ...
          <p className="text-sm text-foreground">
            <strong>Always call 112 first</strong> in a life-threatening emergency. These guides are meant to help while you wait for professional help.
          </p>
        </div>
