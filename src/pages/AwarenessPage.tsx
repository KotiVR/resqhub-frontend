...
const preparednessChecklist = [
  "Know your local emergency number (112 or equivalent)",
...
const beforeAmbulanceSteps = [
  { icon: "📞", title: "Call 112 Immediately", desc: "Give your exact location, describe the emergency, and stay on the line." },
          ...
          <div className="bg-secondary rounded-xl p-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { icon: "🚓", service: "Police", number: "100" },
                { icon: "🚒", service: "Fire", number: "101" },
                { icon: "☠️", service: "Poison Control", number: "1800-116-117" },
              ].map((item) => (
                <a
                  key={item.service}
